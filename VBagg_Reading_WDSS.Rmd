...
[`r Citet(References, "VariationalDeepBayes", .opts = list(max.names = 2))`](https://drive.google.com/drive/folders/1Em534k1ot0ZB5Bsp1ZcXZmthK8_Irbvw)
...
[`r Citet(References, "VBAgg", .opts = list(max.names = 2))`](https://arxiv.org/pdf/1805.08463.pdf)
